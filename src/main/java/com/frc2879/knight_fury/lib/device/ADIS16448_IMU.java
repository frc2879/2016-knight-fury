package com.frc2879.knight_fury.lib.device;

//EDITED VERSION
//See https://github.com/FRC5333/2016-Stronghold/blob/master/src%2Fmain%2Fjava%2Ffrc%2Fteam5333%2Flib%2Fdevice%2FADIS16448_IMU.java
...
public class ADIS16448_IMU extends GyroBase implements Gyro, PIDSource, LiveWindowSendable {
    ...
    public ADIS16448_IMU() {
        while (!found_imu && find_attempts < 8) {   // Sometimes SPI is hella slow
            ...
            readRegister(kRegPROD_ID); //second dummy read
